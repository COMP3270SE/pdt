...
############### manager ############
    ...
    # http://localhost:8000/tracker/2/project/1/createiteration
    url(r'^(?P<user_id>[0-9]+)/project/(?P<project_id>[0-9]+)/createiteration$', views.createiteration, name='createiteration'),
